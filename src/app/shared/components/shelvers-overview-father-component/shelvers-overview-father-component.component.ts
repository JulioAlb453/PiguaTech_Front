...
import { ShelversOverviewComponent } from '../shelvers-overview/shelvers-overview.component';
...
export class ShelversOverviewFatherComponentComponent implements OnInit{
  ...
  fetchShelvesData(): void {
    ...
    setTimeout(() => {
      this.dataShelves = [
        {id: 1, name: 'Pecera 1', status : 'Optimo', zone: 'Lado este del estanque'},
        {id: 2, name: 'Pecera 1', status : 'Alerta', zone: 'Lado este del estanque'},
        {id: 3, name: 'Pecera 1', status : 'Alerta', zone: 'Lado este del estanque'},
        {id: 4, name: 'Pecera 1', status : 'Optimo', zone: 'Lado este del estanque'},
        {id: 5, name: 'Pecera 1', status : 'Optimo', zone: 'Lado este del estanque'}
      ];
